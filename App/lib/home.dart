...
import 'package:helping_hand/services/FirebaseMessagingService.dart';
                ...
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  WidgetsBinding.instance.addPostFrameCallback((_) async {
                    ...
                    var notificationsProvider =
                        Provider.of<NotificationPreferences>(context,
                            listen: false);
                    notificationsProvider.messagingService =
                        FirebaseMessagingService();

                    await notificationsProvider.messagingService
                        .initialize(user.uid);
                  });
